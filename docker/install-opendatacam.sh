...
function docker_compose_setup() {
  ...
  wget -N https://raw.githubusercontent.com/Hadleigh-Schwartz/opendatacam/$VERSION/docker/run/$PLATFORM/docker-compose.yml
...
if [ ! -f ./config.json ]; then
    ...
    wget -N https://raw.githubusercontent.com/Hadleigh-Schwartz/opendatacam/$VERSION/config.json
